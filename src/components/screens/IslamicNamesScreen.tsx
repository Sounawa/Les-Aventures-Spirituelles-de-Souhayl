    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <p
            className="text-2xl font-amiri text-stone-800 dark:text-teal-100 leading-relaxed truncate"
            dir="rtl"
          >
            {name.nameAr}
          </p>
...
export function IslamicNamesScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 via-emerald-50/50 to-teal-50 dark:from-stone-900 dark:via-stone-900 dark:to-stone-950">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-teal-50/80 dark:bg-stone-900/80 backdrop-blur-sm border-b border-teal-200/30 dark:border-stone-700/30">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <Sparkles className="w-5 h-5 text-teal-500 dark:text-teal-400 shrink-0" />
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        ...
        >
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-stone-200 dark:border-stone-700 bg-white/70 dark:bg-stone-800/70 text-sm text-stone-700 dark:text-stone-300 placeholder:text-stone-400 dark:placeholder:text-stone-500 focus:outline-none focus:ring-2 focus:ring-teal-300 dark:focus:ring-teal-600 focus:border-teal-300 dark:focus:border-teal-600 transition-all"
          />
        </motion.div>
