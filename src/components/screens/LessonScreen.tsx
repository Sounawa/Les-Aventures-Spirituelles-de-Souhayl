          ...
          <div className="space-y-4">
            ...
            {allLessons.map((lesson, idx) => (
              ...
              >
                ...
                <blockquote className="border-l-3 border-teal-400 pl-4 italic text-stone-500 dark:text-stone-400 text-sm bg-teal-50/50 dark:bg-teal-900/10 py-2 rounded-r-lg">
                  « {lesson.quote} »
                </blockquote>
