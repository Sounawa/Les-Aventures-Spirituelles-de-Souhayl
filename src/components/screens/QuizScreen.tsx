...
export default function QuizScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-amber-50 to-teal-50 dark:from-stone-900 dark:via-stone-900 dark:to-stone-950">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-purple-50/80 dark:bg-stone-900/80 backdrop-blur-sm border-b border-amber-200/30 dark:border-stone-700/30">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {chapter && <p className="text-xs text-amber-600 dark:text-amber-400" dir="rtl">{chapter.titleAr}</p>}
          </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        {!quizFinished ? (
              ...
              <div className="bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/30 dark:border-stone-700/30 shadow-sm mb-4">
                ...
                <div className="space-y-2 mt-4">
                  {questions[currentQuestion]?.options.map((option, idx) => {
                    ...
                    let optionStyle = 'border-stone-200/50 dark:border-stone-700/50 bg-stone-50/50 dark:bg-stone-700/50 hover:bg-amber-50 dark:hover:bg-stone-700 hover:border-amber-200 dark:hover:border-stone-600';
              ...
              <AnimatePresence>
                {showResult && (
                  ...
                  >
                    <Button
                      onClick={handleNext}
                      className="w-full h-12 bg-gradient-to-r from-purple-500 to-amber-500 hover:from-purple-600 hover:to-amber-600 text-white rounded-xl font-medium"
                    >
          ...
          >
            <div className="bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm rounded-2xl p-8 border border-amber-200/30 dark:border-stone-700/30 shadow-sm mb-4">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              >
                {score >= Math.ceil(questions.length * 0.8) ? (
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-amber-300 to-orange-400 shadow-lg">
            ...
            <div className="flex gap-3">
              ...
              <Button
                onClick={handleBack}
                className="flex-1 h-12 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 rounded-xl"
              >
                Continuer
              </Button>
            </div>
