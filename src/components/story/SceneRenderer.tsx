      ...
      {visible && (
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center z-40">
          {particles.map((p) => (
            <motion.span
              key={p.id}
              className="absolute text-teal-400 text-lg select-none"
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <motion.div
            ...
            className="w-8 h-8 mx-auto mb-3 border-2 border-teal-400 border-t-transparent rounded-full"
          />
    ...
    <div className="relative min-h-[70vh]">
      ...
      <div className="relative z-10 px-4 py-6 md:px-8 md:py-8 max-w-2xl mx-auto">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 shrink-0 ml-2">
              ...
              <motion.button
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                  isSpeaking
                    ...
                    : 'bg-white/60 dark:bg-stone-800/60 backdrop-blur-sm text-stone-500 dark:text-stone-400 hover:text-teal-600 border border-teal-200/30 dark:border-stone-700/30'
                }`}
              ...
              <span className="flex items-center gap-1 bg-white/60 dark:bg-stone-800/60 backdrop-blur-sm px-2 py-1.5 rounded-full border border-teal-200/20 dark:border-stone-700/20">
                <StarProgress
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Sparkles className="w-4 h-4 text-teal-500 animate-sparkle" />
            {scene.title}
          </motion.h2>
        </AnimatePresence>
        ...
        >
          ...
          {narrationComplete && !isSpeaking && (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={handleNarrate}
              className="mt-3 flex items-center gap-1.5 text-xs text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 transition-colors"
            >
          ...
          {narrationComplete && hasChoices && (
            ...
            >
              ...
              <div className="relative rounded-xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-teal-100/50 via-emerald-50/30 to-teal-100/20 dark:from-teal-900/20 dark:via-emerald-900/10 dark:to-teal-900/10" />
                <div className="relative backdrop-blur-sm border border-teal-200/40 dark:border-teal-700/20 rounded-xl p-4 md:p-5">
                  {/* Header with title and instruction */}
                  <div className="flex items-center gap-2 mb-1">
                    <div className="h-px flex-1 bg-teal-300/30 dark:bg-teal-500/20" />
          ...
          {showContinue && (
            ...
            >
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white rounded-xl shadow-lg golden-glow-hover transition-all min-h-[48px]"
              >
                Continuer
        ...
        <AnimatePresence>
          {showLesson && scene.lesson && (
            <motion.div
              ...
              className="mt-6 parchment-card rounded-xl p-5 islamic-border bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-stone-800/80 dark:to-stone-800/60"
            >
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 rounded-full bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center">
                  <BookOpen className="w-4 h-4 text-teal-700 dark:text-teal-400" />
                </div>
                <h3 className="font-bold text-teal-800 dark:text-teal-300">{scene.lesson.title}</h3>
              </div>
              <p className={`${fontSizeClass} text-stone-600 dark:text-stone-300 mb-4 leading-relaxed`}>{scene.lesson.content}</p>
              <blockquote className="border-l-3 border-teal-400 pl-4 italic text-stone-500 dark:text-stone-400 text-sm mb-4 bg-teal-50/50 dark:bg-teal-900/10 py-2 rounded-r-lg">
                « {scene.lesson.quote} »
              </blockquote>
              ...
              {showContinueAfterLesson && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleContinue}
                  className="mt-2 w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white rounded-xl shadow-lg golden-glow-hover transition-all min-h-[48px]"
                >
                  Continuer
                  <ChevronRight className="w-4 h-4" />
                </motion.button>
        ...
        {narrationComplete && scene.isEnding && (
          ...
          >
            ...
            <motion.h3
              ...
              className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-teal-600 via-emerald-500 to-teal-600 bg-clip-text text-transparent"
            >
              🎉 Masha&apos;Allah !
            </motion.h3>
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-teal-300 to-emerald-400 shadow-lg golden-glow"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-3">
              ...
              <motion.button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white rounded-xl shadow-lg golden-glow-hover transition-all min-h-[48px] font-bold"
              >
