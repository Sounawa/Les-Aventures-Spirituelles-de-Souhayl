...
export const verseThemeConfig: Record<QuranVerse['theme'], {
  ...
  sagesse: {
    ...
    darkBorderColor: 'dark:border-emerald-700/30',
    bgColor: 'from-emerald-50 to-teal-50',
    darkBgColor: 'dark:from-emerald-950/20 dark:to-teal-950/20',
  ...
  espoir: {
    ...
    darkBgColor: 'dark:from-teal-950/20 dark:to-cyan-950/20',
    leftBorder: 'border-l-teal-500 dark:border-l-teal-400',
    badgeBg: 'bg-teal-100 dark:bg-teal-900/30',
  },
  paix: {
  ...
  bonte: {
    ...
    bgColor: 'from-orange-50 to-teal-50',
    darkBgColor: 'dark:from-orange-950/20 dark:to-teal-950/20',
